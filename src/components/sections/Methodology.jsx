...
const steps = [
  ...
  { icon: PenTool, title: 'Practice', desc: 'Extensive assignments and study material.' },
...
export function Methodology() {
  return (
    <section className="py-24 bg-navy-900 text-white relative overflow-hidden" id="methodology">
      <div className="absolute top-0 right-0 w-full h-full bg-orb-1 opacity-20 blur-3xl pointer-events-none"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <p className="text-wavefront-400 font-semibold tracking-wider uppercase text-sm mb-3">Why Wavefront</p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start relative mt-16">
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-navy-800 border-2 border-wavefront-500 flex items-center justify-center mb-6 shadow-lg shadow-wavefront-500/20">
                  <Icon className="w-7 h-7 text-wavefront-400" />
                </div>
